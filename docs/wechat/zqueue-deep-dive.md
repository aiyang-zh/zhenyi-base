...
上一篇发了 [zhenyi-base](https://zhenyi-site.pages.dev/) 整体能力后，很多人问：无锁队列 **16.7 ns/op**、0 分配，和 channel 有啥区别？MPSC 场景该用哪个？
...
**完整 96 组数据**：见仓库 [docs/benchmark/zqueue_matrix_results.txt](https://github.com/aiyang-zh/zhenyi-base/blob/main/docs/benchmark/zqueue_matrix_results.txt)。示例与图表见 [官网](https://zhenyi-site.pages.dev/)，欢迎试用、反馈。
